...
class NilaiSeeder extends Seeder
{
    ...
    {
        $course_student = [
            [ 'course_id' => 1, 'student_id' => 1, 'nilai' => 'B', ],
            [ 'course_id' => 2, 'student_id' => 1, 'nilai' => 'A', ],
            [ 'course_id' => 3, 'student_id' => 1, 'nilai' => 'B', ],
            [ 'course_id' => 4, 'student_id' => 1, 'nilai' => 'A', ],

            [ 'course_id' => 1, 'student_id' => 2, 'nilai' => 'A', ],
            [ 'course_id' => 2, 'student_id' => 2, 'nilai' => 'B', ],
            [ 'course_id' => 3, 'student_id' => 2, 'nilai' => 'A', ],
            [ 'course_id' => 4, 'student_id' => 2, 'nilai' => 'B', ],

            [ 'course_id' => 1, 'student_id' => 3, 'nilai' => 'A', ],
            [ 'course_id' => 2, 'student_id' => 3, 'nilai' => 'A', ],
            [ 'course_id' => 3, 'student_id' => 3, 'nilai' => 'B', ],
            [ 'course_id' => 4, 'student_id' => 3, 'nilai' => 'B', ],

            [ 'course_id' => 1, 'student_id' => 6, 'nilai' => 'A', ],
            [ 'course_id' => 2, 'student_id' => 6, 'nilai' => 'A', ],
            [ 'course_id' => 3, 'student_id' => 6, 'nilai' => 'B', ],
